...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form action="{{route('admin.deadlines.update', ['id' => $deadline->id])}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    @method('PATCH')
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            <select id="deadline_category_id" name="deadline_category_id" class="form-control">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{$category->id}}" {{$deadline->deadline_category_id==$category->id?"selected":""}}>{{$category->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            <input type="text" required name="name" id="name" class="form-control" value="{{$deadline->name}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-1">
                        ...
                        <div class="form-group col-sm-4">
                            <input type="text" name="description" id="description" class="form-control" value="{{$deadline->description}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-1">
                        ...
                        <div class="form-group col-sm-4">
                            <input type="date" name="deadline_at" id="deadline_at" class="form-control" value="{{$deadline->deadline_at}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-1">
                        ...
                        <div class="form-group col-sm-4">
                            <select id="customer_id" name="customer_id" class="form-control">
                                ...
                                @foreach($customers as $customer)
                                    <option value="{{$customer->id}}" {{$deadline->customer_id==$customer->id?"selected":""}}>{{$customer->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
